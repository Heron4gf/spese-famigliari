...
/**
 * Componente per la visualizzazione di una griglia di transazioni.
 * La sua istanza viene creata tramite il builder generato da Lombok,
 * che permette di specificare opzionalmente una lista iniziale di transazioni.
 */
@Getter
public class TransactionGridComponent implements NodeBuilder {
    private final GridPane grid;
    private final SimpleDateFormat dateFormatter = new SimpleDateFormat("dd/MM/yyyy");

    /**
     * Costruisce il componente griglia delle transazioni.
     * È annotato con @Builder per generare un builder che permette di passare una collezione iniziale.
     *
     * @param initialTransactions La collezione iniziale di transazioni da visualizzare. Può essere null.
     */
    @Builder
    ...
    /**
     * Aggiorna la griglia con una nuova collezione di transazioni,
     * cancellando i dati precedenti.
     *
     * @param transactions Le transazioni da visualizzare.
     */
    ...
    /**
     * Rimuove tutte le righe di dati dalla griglia, conservando solo l'intestazione.
     */
